...
insert into sys_role_menu(role_id,menu_id) select 1,m.menu_id from sys_menu m where m.menu_id between 2100 and 2115 and not exists(select 1 from sys_role_menu rm where rm.role_id=1 and rm.menu_id=m.menu_id);
